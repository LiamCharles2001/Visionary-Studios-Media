  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                <Image src={"/assets/portfolio_1.jpg"} alt="a cool image" width={200} height={200} loading="lazy" className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"/>
              </a>
              <div className="p-5">
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
              <Image src={"/assets/portfolio_2.jpg"} alt="a cool image" width={200} height={200} loading="lazy" className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Jese Leos</a>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
              <Image src={"/assets/portfolio_3.jpg"} alt="a cool image" fill loading="lazy" className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"/>
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
              {/* <Image src={"/assets/portfolio_5.jpg"} alt="a cool image" width={200} height={200} object-fit="cover" loading="lazy" className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"/> */}
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Lana Byrd</a>
