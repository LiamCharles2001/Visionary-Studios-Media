...
const TestimonialSection = () => {
  return (
    <section className="bg-white dark:bg-zinc-900" id="testimonials">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <p className="font-light text-zinc-500 lg:mb-16 sm:text-xl dark:text-zinc-400">
            We've worked with many talented people, helping them to achieve their goals by editing their videos
          </p>
        </div>
        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          ...
          <div className="items-center bg-zinc-50 rounded-lg shadow sm:flex dark:bg-zinc-800 dark:border-zinc-700">
            ...
            <div className="p-5">
              ...
              <p className="mt-3 mb-4 font-light text-zinc-500 dark:text-zinc-400">
                “Honestly, I loved the video so much bro!”
              </p>
              {/* <ul className="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white">
