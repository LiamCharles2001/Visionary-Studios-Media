...
<section className="relative">
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md">
            ...
            <p className="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-200">We help video creators on lifting the video editing burdeon from them so they can focus on what matters.*****</p>
    ...
    <Image objectFit='cover' fill src="/assets/timeline-bottom.jpg" alt="Video Editing Service Logo" className="-z-10 blur-md brightness-95"/>
</section>
  );
};
