          ...
          <div className="flex items-center border-b border-b-white/5 py-5 md:grid md:grid-cols-6">
            <div className="flex">
              <a href="/">
                ...
                >
                  <title>Visionary Studios Media</title>
                  <path
            ...
            <div className="flex justify-end">
              <a
                target="_self"
                className="group/link-new inline-flex cursor-pointer items-center transition gap-1 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full text-zinc-50 bg-white/5 hover:bg-emerald-400 hover:text-emerald-950 disabled:bg-white/5 disabled:text-zinc-50"
...
{/* Mobile  */}
      <header className="fixed inset-x-0 top-0 z-50 py-4 md:hidden border-b border-b-white/5 bg-zinc-950">
        <div className="mx-auto max-w-screen-xl px-6 md:px-10">
...
{/* */}
            ...
            <nav className="absolute inset-x-0 top-full z-10 mt-px flex-col p-6 bg-zinc-950 shadow-2xl hidden"> {/* THERE IS A HIIDEN TAG HERE*/}
              ...
              <a
                target="_self"
                className="group/link-new inline-flex cursor-pointer items-center transition gap-1 px-4 sm:px-5 sm:py-2 rounded-full hover:bg-emerald-400 hover:text-emerald-950 disabled:bg-white/5 disabled:text-zinc-50 my-6 justify-center bg-emerald-400 py-3 font-display text-lg font-medium text-zinc-950"
                href="https://console.upstash.com"
              >
                <span>Login</span>
              </a>
