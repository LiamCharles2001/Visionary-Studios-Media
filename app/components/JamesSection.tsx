      ...
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div className="font-light sm:text-lg text-zinc-400">
          ...
          <ul className="flex space-x-4 sm:mt-0">
            <li>
              <a
                href="https://www.youtube.com/channel/UCraD3Eim7u67vBrMms7GaXw"
                target="_blank"
            ...
            <li>
              <a
                href="https://www.tiktok.com/@jimmynickyt"
                target="_blank"
                className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.instagram.com/lifeofjimmynick/"
                target="_blank"
                className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white"
              >
                <svg
            ...
            <li>
              <a
                href="https://twitter.com/lifeofjimmynick"
                target="_blank"
                className="text-zinc-500 hover:text-zinc-900 dark:hover:text-white"
              >
                <svg
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          <Image
            className="w-full rounded-lg shadow-2xl shadow-yellow-400 hover:scale-110 transition duration-500"
            width={200}
            height={200}
          ...
          <Image
            className="mt-4 w-full lg:mt-10 rounded-lg shadow-2xl shadow-primary-500 hover:scale-110 transition duration-500"
            width={200}
            height={200}
