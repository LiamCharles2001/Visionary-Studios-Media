  ...
  return (
    <section className="relative pt-[90px] lg:pt-[90px]">
      ...
      <div className="py-2 mx-auto max-w-screen-xl px-4">
        <div className="flex justify-center lg:gap[12rem] sm:gap-[6rem] gap-[1rem] text-white">
          <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full lg:h-12 lg:w-12 bg-primary-500">
            <svg
              className="w-7 h-7"
              viewBox="0 0 16 16"
              fill="currentColor"
